...
🔍 EXIT SIGNAL ANALYSIS REPORT — PAPER MODE

✅ STOP-LOSS TRIGGERED & EXECUTED:
- Trade #3: Dumb Asteroid
  - Entry: $0.00001547 | Current: $0.00000542 (-65.0%)
  - Action: Auto-sold immediately (stop-loss threshold: -30%)
  - P&L: -0.032495 SOL (-64.99%)
  - Hold time: 1.5 hours

📊 UPDATED PORTFOLIO (4 positions):
- Total Invested: 0.2000 SOL
- Current Value: 0.2119 SOL
- Net P&L: +0.0119 SOL (+6.0%)

🟢 OPEN POSITIONS WITH STRONG MOMENTUM:
- UNCEROID (#4): +40.6% — Strong upward momentum, hold for potential take-profit
- MINI MU: +1.6% — Neutral, monitor for breakout

🔴 OPEN POSITIONS WITH RISK:
- EUPHORIA: -6.9% — Below entry, but not yet stop-loss. Monitor for recovery.
- UNCEROID (#5): -11.4% — Below entry, but above stop-loss. Hold unless further decline.

⚠️ TAKE-PROFIT EVALUATION:
- No positions have reached +100% take-profit threshold.
- UNCEROID (#4) at +40.6% shows strong momentum. Recommend holding with trailing stop at +30% from current price. No sell action taken.

✅ ACTION COMPLETED:
- Stop-loss triggered and executed on Dumb Asteroid.
- Portfolio rebalanced. No other exits required.
- Trade journal updated with exit record.
