...
No qualifying token found for paper trade.

Trending tokens scanned: top 3 analyzed.
- Dumb Asteroid (DA): Safety score 55/100 — below threshold.
- MINI MU (MU): Safety score 63/100 — above 60, liquidity $39.6K — meets criteria.
- Kokopi Koalas (KOKOP): Contract safe, but liquidity $154K — skipped due to age >24h.

MINI MU (MU) passed safety check and had sufficient liquidity, but trade was blocked by risk-manager: daily P&L at -65% (exceeding -20% limit) and already holding 4 open positions (max 5, but duplicate token detected).

No trade executed. System operating within safety limits.
