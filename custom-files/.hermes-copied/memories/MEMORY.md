...
Based on 8 closed trades (1W/7L, 12% win rate).

### Insights
- Win rate: 12% (1W/7L)
- Avg win: +188.6% | Avg loss: -30.7%
- Net P&L: +0.002472 SOL
- Avg hold (wins): 2.7h | Avg hold (losses): 10.7h
...
- [MEDIUM] AVOID tokens where 'trending' is the main signal (12% win rate)
  - Evidence: 1 wins, 7 losses
- [MEDIUM] AVOID tokens where 'safety' is the main signal (12% win rate)
  - Evidence: 1 wins, 7 losses
- [MEDIUM] AVOID tokens where 'liquidity' is the main signal (14% win rate)
  - Evidence: 1 wins, 6 losses
- [LOW] AVOID tokens where 'boost' is the main signal (0% win rate)
  - Evidence: 0 wins, 2 losses
- [LOW] AVOID tokens where 'clean' is the main signal (0% win rate)
  - Evidence: 0 wins, 2 losses

_Last updated: 2026-04-19T21:59:13.813590+00:00_
